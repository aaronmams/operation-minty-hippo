---
title: "Skill-6-Advanced-Visualizations-v.1"
author: "aaron mamula"
date: "5/8/2020"
...
Working with the Census Bureau ACS data from Skills-5 I'm going to create an informative map using the spatial data package *sf*. The exercise will proceed more-or-less like this:
...
ca.counties <- st_read(here('data/CA_Counties/CA_Counties_TIGER2016.shp'))
...
In the last section I made a base map. This was a map of California county boundaries. Here, I'm going to draw on the skills from ```SKills-5-Advanced-Data-Import-v.2``` and pull some data from the 2018 ACS to use with the basemap.
...
```{r}
ca.counties <- ca.counties %>%  left_join(edu,by=c('NAME'))
